...
public class CouncilGenSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UltraViewPager ultraViewPager = (UltraViewPager) findViewById(R.id.council_view_pager);
                ArrayList<CouncilUserClass> genSecyList = new ArrayList<>();
        CouncilUserClass genAcSecy=new CouncilUserClass("Vivek Rathore","Academic General Secretary",""," Vivekrathore9111@gmail.com",R.drawable.vivek1);
      ...
      //  genSecyList.add(genTechSecy);
        ...
        ultraViewPager.setScrollMode(UltraViewPager.ScrollMode.HORIZONTAL);
                PagerAdapter adapter = new UltraPagerAdapter(true, this, genSecyList);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        androidx.appcompat.app.ActionBar genSecyActionBar = getSupportActionBar();
