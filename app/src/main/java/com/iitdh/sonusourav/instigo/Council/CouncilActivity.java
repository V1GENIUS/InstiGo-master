...
public class CouncilActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initCommitteeName();
        initArrayImage();
        RecyclerView recyclerView = findViewById(R.id.recycler_view_council);
        recyclerView.setHasFixedSize(true);
        int numberOfColumns = 2;
        recyclerView.setLayoutManager(new GridLayoutManager(this, numberOfColumns));
        CouncilRecyclerAdapter recyclerAdapter = new CouncilRecyclerAdapter(councilName, councilImage);
