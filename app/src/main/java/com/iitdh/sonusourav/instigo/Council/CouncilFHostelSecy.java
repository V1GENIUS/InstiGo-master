...
public class CouncilFHostelSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UltraViewPager ultraViewPager = (UltraViewPager) findViewById(R.id.council_view_pager);
                ArrayList<CouncilUserClass> FHostelList = new ArrayList<>();
        CouncilUserClass jrHostelSecy=new CouncilUserClass("Vivek rathore","Jr Hostel Secretary","9111084526"," va84357279@gmail.com",R.drawable.vivek2);

        FHostelList.add(jrHostelSecy);

        //main code starts here
        ultraViewPager.setScrollMode(UltraViewPager.ScrollMode.HORIZONTAL);
                PagerAdapter adapter = new UltraPagerAdapter(true, this, FHostelList);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        androidx.appcompat.app.ActionBar FHostelActionBar = getSupportActionBar();
