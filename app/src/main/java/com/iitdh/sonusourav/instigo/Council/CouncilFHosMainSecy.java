...
public class CouncilFHosMainSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass groundSecy=new CouncilUserClass(" Ankesh Verma ","Ground Floor Hostel Secretary","9425413119"," ankesh201005itt@sdbc.ac.in ",R.drawable.ankesh);
        CouncilUserClass firstSecy=new CouncilUserClass(" Vivek Rathore ","First Floor Hostel Secretary","9111084526"," Vivekrathore9111@gmail.com",R.drawable.vivek3dress);
