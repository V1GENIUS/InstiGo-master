...
public class CouncilCulturalSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UltraViewPager ultraViewPager = (UltraViewPager) findViewById(R.id.council_view_pager);
                ArrayList<CouncilUserClass> culturalList = new ArrayList<>();
        ...
        ultraViewPager.setScrollMode(UltraViewPager.ScrollMode.HORIZONTAL);
                PagerAdapter adapter = new UltraPagerAdapter(true, this, culturalList);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        androidx.appcompat.app.ActionBar culturalActionBar = getSupportActionBar();
